...
#define osThread(name) \
    ...
    osThreadId osThreadCreate(osThreadDef_t const *thread_def, void *argument);
...
#define osTimer(name) \
    ...
    osTimerId osTimerCreate(osTimerDef_t const *timer_def, os_timer_type type, void *argument);
...
#define osMutex(name) \
    ...
    osMutexId osMutexCreate(osMutexDef_t const *mutex_def);
...
#define osSemaphore(name) \
    ...
    osSemaphoreId osSemaphoreCreate(osSemaphoreDef_t const *semaphore_def, int32_t count);
...
#define osPool(name) \
    ...
    osPoolId osPoolCreate(osPoolDef_t const *pool_def);
...
#define osMessageQ(name) \
    ...
    osMessageQId osMessageCreate(osMessageQDef_t const *queue_def, osThreadId thread_id);
...
#define osMailQ(name) \
    ...
    osMailQId osMailCreate(osMailQDef_t const *queue_def, osThreadId thread_id);
    ...
    /// \return status code that indicates the execution status of the function.
    osStatus osMailPut(osMailQId queue_id, void const *mail);
